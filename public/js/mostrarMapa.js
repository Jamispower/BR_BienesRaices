...
eval("__webpack_require__.r(__webpack_exports__);\n(function(){\r\n    const lat = document.querySelector('#lat').textContent  //logical OR porque el value del documento si no se ha asignado es '' y no null\r\n    const lng = document.querySelector('#lng').textContent\r\n    const calle = document.querySelector('#calle').textContent\r\n    \r\n    const mapa = L.map('mapa').setView([lat, lng ], 14);\r\n\r\n    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {\r\n        attribution: '&copy; <a href=\"https://www.openstreetmap.org/copyright\">OpenStreetMap</a> contributors'\r\n    }).addTo(mapa);\r\n\r\n    L.marker([lat,lng])\r\n        .addTo(mapa)\r\n        .bindPopup(calle)\r\n\r\n})()\n\n//# sourceURL=webpack://bienesraices_p1/./src/js/mostrarmapa.js?");
